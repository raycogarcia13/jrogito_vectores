module.exports = {   
    en:{
        messageT:"%responsible has completed the task, please click this link %link",
        messageH:`
        <!DOCTYPE html>
        <html lang="en">
          <head>
                    ...
                    <tr>
                      <td class="innerpadding top-padding">
                        ...
                        >
                          <tr>
                            <td>
                              <h3>%responsible has completed the task</h3>
                            </td>
                          </tr>
                        </table>
                      </td>
                        ...
                        >
                          <tr>
                             <td style="padding-bottom:20px; text-align:center">
                              <a type="button"  href="%link" class="btn-primary" style="color:#fff; text-decoration: none;"><strong>SEE TASK SOLUTION</strong></a>
                            </td>
                          </tr>
                        </table>
                      </td>
        ...
        `,
        subject:" New Task Solution to a task you assigned"
    }
}