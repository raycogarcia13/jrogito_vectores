module.exports = {   
    en:{
        messageT:"%sender has send you a notification",
        messageH:`
        <!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <body>
    ...
    >
      <tr>
            ...
            <tr>
              <td class="innerpadding top-padding">
                ...
                >
                  <tr>
                    <td>
                      <h3>%sender has sent you a notification</h3>
                    </td>
                  </tr>
                </table>
              </td>
                ...
                >
                  <tr>
                     <td style="padding-bottom:20px; text-align:center">
                      <a type="button" href="%link" class="btn-primary" style="color:#fff; text-decoration: none;"><strong>SEE NOTIFICATION</strong></a>
                    </td>
                  </tr>
                </table>
              </td>
        ...
        `,
        subject:" New notification has send to you"
    }
}