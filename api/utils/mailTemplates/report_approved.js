module.exports = {   
    en:{
        messageT:"Claim Approved, for acces to this claim please visit this link %link",
        messageH:`
        <!DOCTYPE html>
        <html lang="en">
          <head>
                      ...
                      <td class="innerpadding">
                        ...
                        >
                          <tr>
                            <td>
                              <span class="text"
                  >Dear %name, your claim has been received and approved. Our
                  specialists are analizing the problem, we will notify you of a
                  solution shortly.</span
                >
                            </td>
                          </tr>
                        </table>
