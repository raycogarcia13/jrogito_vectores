module.exports = {   
    en:{
        messageT:"Claim rejected, for acces to this claim please visit this link %link",
        messageH:`
        <!DOCTYPE html>
        <html lang="en">
          <head>
                    ...
                    <tr>
                      <td class="innerpadding top-padding">
                        ...
                        >
                          <tr>
                            <td>
                              <h3 style="color: #b71c1c">CLAIM REJECTED</h3>
                            </td>
                          </tr>
                        </table>
                        <table
                      ...
                      <td class="innerpadding">
                        ...
                        >
                          <tr>
                            <td>
                              <span class="text"
                                >Dear %name, your claim has been rejected. Click the 
                                button below to see details in Aisco Workspace.</span
                              >
                            </td>
                          </tr>
                        </table>
                        ...
                        >
                          <tr>
                            <td style="padding-bottom:20px; text-align:center">
                              <a type="button"  href="%link" class="btn-primary" style="color:#fff; text-decoration: none;"><strong>VIEW REJECTION NOTE</strong></a>
                            </td>
                          </tr>
                        </table>
                      </td>
