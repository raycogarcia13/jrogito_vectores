module.exports = {   
    en:{
        messageT:"Copy the next link for validate your email: %link",
        messageH:`
        <!DOCTYPE html>
        <html lang="en">
          <head>
                    ...
                    <tr>
                      <td class="innerpadding top-padding">
                        ...
                        >
                          <tr>
                            <td>
                              <h3>Confirm user registration</h3>
                            </td>
                          </tr>
                        </table>
                      </td>
                      ...
                      <td class="innerpadding">
                        ...
                        >
                          <tr>
                            <td>
                              <span class="text">
                              Dear %fullname, thank you for choose our services. Please click the button below to activate your account.</span>
                            </td>
                          </tr>
                        </table>
                      </td>
                    ...
                    <tr>
                      <td style="width: 100%;" class="innerpadding">
                        ...
                        >
                          <tr>
                            <td>
                              <button type="button" onclick="window.open('%link', '_blank')" class="btn-primary"><strong>ACCTIVATE ACCOUNT</strong></button>
                            </td>
                          </tr>
                        </table>
                      </td>
