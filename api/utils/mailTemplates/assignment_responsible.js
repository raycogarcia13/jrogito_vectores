module.exports = {   
    en:{
        messageT:"New warranty report created, please visit this link %link",
        messageH:`
        <!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <body>
    ...
    >
      <tr>
            ...
            <tr>
              <td class="innerpadding">
                ...
                >
                  <tr>
                    <td>
                      <span class="text">Dear %responsible. <br /> <div style="margin-top: 4px;"></div> %assigner have assigned you has responsible 
                        for processing this claim. See details below.</span>
                    </td>
                  </tr>
                </table>
              </td>
        ...
        `,
        subject:"Has be assigned a new claim to you"
    }
}