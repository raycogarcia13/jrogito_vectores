module.exports = {   
    en:{
        messageT:"Claim resolved, for acces to this claim please visit this link %link",
        messageH:`
        <!DOCTYPE html>
        <html lang="en">
          <head>
                      ...
                      <td class="innerpadding">
                        ...
                        >
                          <tr>
                            <td>
                              <span class="text"
                  >Dear %name, your claim has been resolved. Click the 
                  button below to see the solution in Aisco Workspace.</span
                >
                            </td>
                          </tr>
                        </table>
                        ...
                        >
                          <tr>
                             <td style="padding-bottom:20px; text-align:center">
                              <a type="button"  href="%link" class="btn-primary" style="color:#fff; text-decoration: none;"><strong>VIEW SOLUTION</strong></a>
                            </td>
                          </tr>
                        </table>
                      </td>
